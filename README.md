...
ASCEND data can be found at <a href="ascend-data.sri.com">ascend-data.sri.com</a>. Download a zip file ending with "-clean-data.zip" and extract the 300_wf.csv file and the 200_terminal_features.csv files.
